...
export default function User() {
    ...
    const toggleMenu = (e) => {
        const accordion = document.querySelector('.user-account-accordion')
        accordion.classList.toggle('active')
    }

    return(
        <div className='user_svg'>
            <svg className='header-icons' onClick={toggleMenu} fill='white' width={"50px"} height={"50px"} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 122.88 122.88">
                <g>
            ...
            <div className="user-account-accordion" onClick={()=> window.location.pathname = "/"}>
                <div className='list-button header-icons'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill='grey' height="24" width="24" viewBox="0 -960 960 960" >
